...
export default function ProductDetailPage({ product, onNavigate, addToCart, addToWishlist }) {
  ...
  if (!product) {
    return (
      <div style={{ padding: "20px" }}>
        ...
        <button onClick={() => onNavigate('home')}>Go back to Home</button>
      </div>
    )
  }
  ...
  return (
    <div style={{ maxWidth: "800px", margin: "20px auto" }}>
      <button onClick={() => onNavigate('home')} style={{ marginBottom: '20px' }}>&larr; Back to Products</button>
